function LFRenderS( libDir, povFile, camParam, outFile, extraOpt, skipExist )
%LFRENDERS Render stereo images (same intrinsic, pure translation)
...
for i = 0:1
    makeCamS(camParam.camFile, camParam, i);
