...
Hx = R(:,1:2) * [1 0; 0 -1] * H(1:2,:);
Hy = R(:,1:2) * [1 0; 0 -1] * H(3:4,:);
...
if nargin < 3
    ...
    fprintf(fout, ['function { int(mod((x+0.5)*image_width,sx)+1)*(%.16g)'...
        '+int(mod((0.5-y)*image_height,sy)+1)*(%.16g)'...
        '+(div((x+0.5)*image_width,sx)+1)*(%.16g)'...
        '+(div((0.5-y)*image_height,sy)+1)*(%.16g)'...
    ...
    fprintf(fout, ['function { int(mod((x+0.5)*image_width,sx)+(%.16g))*(%.16g)'...
        '+int(mod((0.5-y)*image_height,sy)+(%.16g))*(%.16g)'...
        '+(div((x+0.5)*image_width,sx)+(%.16g))*(%.16g)'...
        '+(div((0.5-y)*image_height,sy)+(%.16g))*(%.16g)'...
